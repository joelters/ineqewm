        ...
        for (ii in 1:K){
          ...
          for (jj in ii1:K){
            ...
            for (rr in 1:length(Ynotij)){
              ...
              delta[rr] <- mean(0.5*(Ynotij[rr] + Ynotij[-rr] -
                                      abs(Ynotij[rr] - Ynotij[-rr]))*(a00+a01-a10-a11))
            }
            ...
            if (ii == jj){
              ...
              for (kk in 1:nn1){
                ...
                for (mm in kk1:length(Yii)){
                  ...
                  w <- w + 0.5*(Yii[kk] + Yii[mm] - abs(Yii[kk] - Yii[mm]))*(a11+a10+a01+a00) +
            ...
            #If we are in a square (Ci =/= Cj)
              ...
              for (kk in 1:length(ind[[ii]])){
                ...
                for (mm in mm1:length(Yij)){
                  ...
                  w <- w + 0.5*(Yij[kk] + Yij[mm] - abs(Yij[kk] - Yij[mm]))*(a11+a10+a01+a00) +
